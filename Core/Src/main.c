...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
volatile ring_buffer_t rxBuffer = {0U};
volatile ring_buffer_t txBuffer = {0U};

volatile uint8_t rxDataBuffer[RX_BUFFER_SIZE] = {0U};
volatile uint8_t txDataBuffer[TX_BUFFER_SIZE] = {0U};
